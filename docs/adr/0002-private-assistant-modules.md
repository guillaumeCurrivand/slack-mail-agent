...
The user confirmed the shared understanding and authorized implementation. The Tasks module is a future use case, not part of this restructuring's implementation scope. Current contracts live in [the product specification](../product-spec.md) and [module guide](../adding-a-module.md); the [completed implementation plan](../archive/modularization-plan.md) is retained as history.
